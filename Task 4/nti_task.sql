...
CREATE TABLE `admins` (
  ...
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT '1=>active(default) , 0=> blocked',
...
CREATE TABLE `coupons` (
  ...
  `mini_order_value` bigint(20) NOT NULL,
  `max_discount_value` bigint(20) NOT NULL,
  `usage` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0=> not used(default) , 1=>used',
  `usage_per_user` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `offers` (
  ...
  `offered_item` varchar(30) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `orders` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0=>not deliverd(default) , 1=>deliverd',
...
CREATE TABLE `users` (
  ...
  `email_verified_at` timestamp NULL DEFAULT NULL,
  `forget_code` mediumint(6) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `subcategories`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cat_subcat_fk` (`category_id`);
...
--
ALTER TABLE `favs`
  ADD CONSTRAINT `favs_product_fk` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  ADD CONSTRAINT `user_favs_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
...
--
ALTER TABLE `subcategories`
  ADD CONSTRAINT `cat_subcat_fk` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`);
COMMIT;
