...
if ($_POST) {
    ...
    $message = "<div class='alert alert-success' role='alert'>
            <ul>
                ...
                <li> Your Loan is : $loan EGP</li>
                <li> Number of Years is : $years Years</li>
                <li> The Interest is : $interest EGP </li>
                <li> The Total Money : $total EGP</li>
                <li> Paid per Month : $month EGP</li>
            </ul>
        </div>";
}
?>
...
<body>
    <div class="container">
        <div class="row ">
            <div class="col-12 mt-5 text-center text-dark font-weight-bold h3">
                Bank
            </div>
